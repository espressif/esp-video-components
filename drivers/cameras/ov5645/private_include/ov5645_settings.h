...
#define OV5645_IDI_CLOCK_RATE_2592x1944_15FPS     (42000000ULL)
#define OV5645_IDI_CLOCK_RATE_1920x1080_15FPS     (42000000ULL)
// Note, all clock configurations default to using 2 data lane mode
...
static const reginfo_t ov5645_mipi_reset_regs[] = {
    {0x3103, 0x11},
...
static const reginfo_t ov5645_mipi_stream_on[] = {
    {0x3008, OV5645_SOFT_POWER_DOWN_DIS},
    {0x4202, 0x00},
    {OV5645_REG_END, 0x00},
};

static const reginfo_t ov5645_mipi_stream_off[] = {
    {0x4202, 0x0f}, /* Sensor enter LP11*/
    {0x3008, OV5645_SOFT_POWER_DOWN_EN},
    {OV5645_REG_END, 0x00},
};

static const reginfo_t ov5645_MIPI_2lane_yuv422_960p_30fps[] = {
...
static const reginfo_t ov5645_MIPI_2lane_yuv422_1080p_15fps[] = {
    ov5645_settings_yuv422
    {0x5001, 0xa3},
    {0x3103, 0x03},
    {0x3503, 0x07},
...
static const reginfo_t ov5645_MIPI_2lane_yuv422_2592x1944_15fps[] = {
...
static const reginfo_t ov5645_MIPI_2lane_yuv422_640x480_24fps[] = {
    ov5645_settings_yuv422
    {0x5001, 0xa3},
    {0x3103, 0x03},
    {0x3503, 0x07},
