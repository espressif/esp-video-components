...
#ifndef _SOC_LP_I3C_MST_STRUCT_H_
#define _SOC_LP_I3C_MST_STRUCT_H_
...
typedef volatile struct {
    ...
    union {
        struct {
            uint32_t tx_data_buf_thld              :    3;  /*Transmit Buffer Threshold Value. This field controls the number of empty locations in the Transmit FIFO that trigger the TX_THLD_STAT interrupt. Supports values: 000:2  001:4  010:8  011:16  100:32,  else:31*/
            uint32_t rx_data_buf_thld              :    3;  /*Receive Buffer Threshold Value. This field controls the number of empty locations in the Receive FIFO that trigger the RX_THLD_STAT interrupt. Supports: 000:2  001:4  010:8  011:16  100:32, else:31*/
...
extern lp_i3c_mst_dev_t LP_I3C_MST;
#ifdef __cplusplus
}
#endif
...
#endif /*_SOC_LP_I3C_MST_STRUCT_H_ */
