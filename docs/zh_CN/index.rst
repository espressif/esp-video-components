...
`ESP-Video-Components <https://github.com/espressif/esp-video-components>`_ 是乐鑫开发的相机应用框架，主要提供以下功能：

- 支持 MIPI、DVP、SPI、USB 四种相机接口的应用开发
- 允许同时使用多个相机传感器
...
- 支持集成图像处理算法库 `esp-ipa <https://github.com/espressif/esp-video-components/tree/master/esp_ipa>`_
