 ...
 *
 * @param[in] dev Camera sensor device handle that was created by `sensor_detect`.
 ...
 *
 * @param[in] dev Camera sensor device handle that was created by `sensor_detect`.
 * @param[out] format_array The pointer to hold the description of the currently supported output format.
 * @return
 *      - ESP_OK: Success
 *      - ESP_ERR_INVALID_ARG: Error in the passed arguments.
 *      - ESP_ERR_NOT_SUPPORTED: The sensor driver does not support this operation.
 ...
 *
 * @param[in] dev Camera sensor device handle that was created by `sensor_detect`.
 * @param[out] format The pointer to hold the description of the current output format.
 * @return
 *      - ESP_OK: Success
