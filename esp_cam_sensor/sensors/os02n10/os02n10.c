...
static const esp_cam_sensor_format_t os02n10_format_info_mipi[] = {
...
#if CONFIG_CAMERA_OS02N10_MIPI_RAW10_1920X1080_25FPS
    {
        ...
        .width = 1920,
        .height = 1080,
        .regs = os02n10_mipi_2lane_24Minput_1920x1080_raw10_25fps,
        .regs_size = ARRAY_SIZE(os02n10_mipi_2lane_24Minput_1920x1080_raw10_25fps),
        .fps = 25,
...
#if CONFIG_CAMERA_OS02N10_MIPI_RAW10_1280X720_50FPS
    {
        ...
        .width = 1280,
        .height = 720,
        .regs = os02n10_mipi_2lane_24Minput_1280x720_raw10_50fps,
        .regs_size = ARRAY_SIZE(os02n10_mipi_2lane_24Minput_1280x720_raw10_50fps),
        .fps = 50,
...
#if CONFIG_CAMERA_OS02N10_MIPI_RAW8_1920X1080_25FPS
    {
        ...
        .width = 1920,
        .height = 1080,
        .regs = os02n10_mipi_2lane_24Minput_1920x1080_raw8_25fps,
        .regs_size = ARRAY_SIZE(os02n10_mipi_2lane_24Minput_1920x1080_raw8_25fps),
        .fps = 25,
        .isp_info = &os02n10_isp_info_mipi[0],
        .mipi_info = {
            .mipi_clk = 288000000,
...
#if CONFIG_CAMERA_OS02N10_MIPI_RAW8_1280X720_50FPS
    {
        ...
        .width = 1280,
        .height = 720,
        .regs = os02n10_mipi_2lane_24Minput_1280x720_raw8_50fps,
        .regs_size = ARRAY_SIZE(os02n10_mipi_2lane_24Minput_1280x720_raw8_50fps),
        .fps = 50,
        .isp_info = &os02n10_isp_info_mipi[1],
        .mipi_info = {
            .mipi_clk = 326000000,
...
#if CONFIG_CAMERA_OS02N10_MIPI_RAW8_960x540_25FPS
    {
        ...
        .width = 960,
        .height = 540,
        .regs = os02n10_mipi_2lane_24Minput_960x540_raw8_binning_25fps,
        .regs_size = ARRAY_SIZE(os02n10_mipi_2lane_24Minput_960x540_raw8_binning_25fps),
        .fps = 25,
