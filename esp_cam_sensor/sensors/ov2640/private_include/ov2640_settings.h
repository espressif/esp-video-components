...
#define ov2640_settings_yuv422_yuyv \
    {BANK_SEL, BANK_DSP}, \
    {RESET, RESET_DVP}, \
    {IMAGE_MODE, IMAGE_MODE_YUV422_YUYV}, \
    {0xD7, 0x01}, \
    {0xE1, 0x67}, \
    {RESET, 0x00}

#define ov2640_settings_yuv422_uyvy \
    {BANK_SEL, BANK_DSP}, \
    {RESET, RESET_DVP}, \
    {IMAGE_MODE, IMAGE_MODE_YUV422_UYVY}, \
    {0xD7, 0x01}, \
    {0xE1, 0x67}, \
    {RESET, 0x00}

#define ov2640_settings_rgb565_be \
    {BANK_SEL, BANK_DSP}, \
    {RESET, RESET_DVP}, \
    {IMAGE_MODE, IMAGE_MODE_RGB565_BE}, \
    {0xD7, 0x03}, \
    {0xE1, 0x77}, \
    {RESET, 0x00}

#define ov2640_settings_rgb565_le \
    {BANK_SEL, BANK_DSP}, \
    {RESET, RESET_DVP}, \
    {IMAGE_MODE, IMAGE_MODE_RGB565_LE}, \
    {0xD7, 0x03}, \
    {0xE1, 0x77}, \
    {RESET, 0x00}
...
#define init_reglist_DVP_8bit_640x480_XCLK_20_6fps_common \
    {BANK_SEL, BANK_DSP},   \
...
#include "ov2640_dvp_8bit_20Minput_240x240_rgb565_be_25fps.h"
#include "ov2640_dvp_8bit_20Minput_240x240_rgb565_le_25fps.h"
...
#include "ov2640_dvp_8bit_20Minput_640x480_jpeg_25fps.h"

#include "ov2640_dvp_8bit_20Minput_640x480_rgb565_be_6fps.h"
#include "ov2640_dvp_8bit_20Minput_640x480_rgb565_le_6fps.h"

#include "ov2640_dvp_8bit_20Minput_640x480_yuv422_uyvy_6fps.h"
#include "ov2640_dvp_8bit_20Minput_640x480_yuv422_yuyv_6fps.h"

#include "ov2640_dvp_8bit_20Minput_1280x720_jpeg_12fps.h"

#include "ov2640_dvp_8bit_20Minput_1600x1200_jpeg_12fps.h"

#include "ov2640_dvp_8bit_20Minput_1600x1200_raw8_15fps.h"
