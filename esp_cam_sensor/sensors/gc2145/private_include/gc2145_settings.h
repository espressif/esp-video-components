...
#define GC2145_YUV422_FMT 0x00 // send in [Cb Y Cr Y] order.
#else
#define GC2145_YUV422_FMT 0x02 // send in [Y Cb Y Cr] order.
#endif
// Notes that DVP & MIPI need different YUV seq
#define gc2145_settings_yuv422 \
    {GC2145_REG_RESET_RELATED, 0x00}, \
    {GC2145_REG_P0_OUTPUT_FORMAT, GC2145_YUV422_FMT}
...
static const gc2145_reginfo_t gc2145_DVP_8bit_10Minput_320x240_yuv422_13fps[] = {
    {0xfe, 0xe0},
    {0xfe, 0xf0},
    {0xfe, 0xf0},
    {0xfe, 0xf0},
